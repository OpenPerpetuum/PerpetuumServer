...
//            RegisterAutoActivate<AccountCreditHandler>(TimeSpan.FromSeconds(10));
        ...
        private void RegisterEntities()
        {
            ...
            RegisterUnit<StrongholdEntranceTeleport>(); // OPP: Special rift spawned eventfully to transport player to location
            ...
            _builder.Register<Func<EntityDefault,Entity>>(x =>
            {
                ...
                ByName<StrongholdEntranceTeleport>(DefinitionNames.TARGETTED_RIFT); //OPP targetted rift
